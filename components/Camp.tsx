...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      {/* div containing scrolling images*/}
        {/* div containing image 1*/}
          {/* text and images, with transparent bg opacity? */}
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        {/* div containing image 2*/}
          {/* text and images, with transparent bg opacity? */}
          {/* The images are using z-index for that effect */}
          {/* Container padding w/ Smaller Gap */}
        {/* Absolutely positioned div on top of other 2 */}
    </section>
  )
}
